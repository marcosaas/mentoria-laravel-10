...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <meta name="author" content="Plano B Informatica, Marcos Antonio">
        <meta name="generator" content="R-solver v5">
        <title>Gestao</title>
    ...
    <body>
        ...
        <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">R-solver</a>
